        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white rounded-3xl shadow-xl overflow-hidden border border-slate-100">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3">
                    <!-- Guidance Sidebar -->
                    <div class="p-8 bg-slate-50 border-r border-slate-100 lg:col-span-1">
                        ...
                        <ul class="space-y-4 text-sm text-slate-600">
                            <li>
                                <strong class="text-slate-800 block mb-1">Judul Laporan</strong>
                                Gunakan nama yang spesifik, misal: <span class="italic">"Realisasi Dana Desa Tahap I
                                    2026"</span>.
                            </li>
                            <li>
                                <strong class="text-slate-800 block mb-1">Kategori</strong>
                                <span class="block">• <b>Keuangan:</b> APBDes/Realisasi</span>
                                <span class="block">• <b>Kependudukan:</b> Data Warga</span>
                                <span class="block">• <b>Kejadian:</b> Bencana/Event</span>
                            </li>
                            <li>
                                <strong class="text-slate-800 block mb-1">Lampiran</strong>
                                Pastikan file (PDF/Foto) terlihat jelas dan tidak lebih dari 10MB.
                            </li>
                            <li>
                                <strong class="text-slate-800 block mb-1">Keterangan</strong>
                    ...
                    <form action="{{ route('dashboard.laporan.simpan') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div>
                            <label for="judul" class="block text-sm font-semibold text-slate-700 mb-2">Judul Laporan</label>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <select name="kategori" id="kategori" required
                                    class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all outline-none bg-white">
                            ...
                            <div>
                                <label for="tanggal_laporan" class="block text-sm font-semibold text-slate-700 mb-2">Tanggal
                                    Laporan</label>
                        ...
                        <div>
                            <label for="lampiran" class="block text-sm font-semibold text-slate-700 mb-2">Lampiran File
                                (PDF, Gambar, atau Dokumen)</label>
                            <div
                                class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-slate-200 border-dashed rounded-xl hover:border-blue-400 transition-colors">
                        ...
                        <div>
                            <label for="keterangan" class="block text-sm font-semibold text-slate-700 mb-2">Keterangan /
